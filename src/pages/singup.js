...
const signUpUser = () =>{
  ...
  let useDataFirebase = firebaseMethods.writeOperation('users',signUpData)
  //  useDataFirebase.then((resolve) => {dispatch({
  //   type:"usersDataSave",
  //   payload:{
  //     data:signUpData,
  //     onSuccess:"",
  ...
  useDataFirebase.then((resolve) =>console.log("========>",resolve))
